...
<section  class="logo-bar divider divider--56da0 pt-4 pt-lg-5 pt-xl-6 pb-5 pb-md-6 pb-lg-7 pb-xl-8 px-0  scroll">
	<div class="inner section-title"><h2> welcome to My Devops world GOPAL YADAV </h2></div>	<div class="logo-wrapper">
		<div class="logo-grid">
